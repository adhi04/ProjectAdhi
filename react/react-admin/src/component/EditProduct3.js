                        ...
                        <div className="col-lg-6">
                          <form>
                            ...
                            <br />
                              ...
                              <hr />
                              <input type= "text" className="form-control" ref = 'idproduk' defaultValue={this.state.idproduk}/>
                              <div className="form-group row">                                
                                <label className="col-sm-2 form-control-label">Nama Produk</label>
                                <div className="col-sm-10">
                                  <input ref="namaproduk" type="text" placeholder="Nama" defaultValue={this.state.namaproduk} className="form-control" />
                                </div>
                              </div>
                              <div className="form-group row">
                              ...
                              <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                  <input ref="hargaproduk" type="number" placeholder="Harga" defaultValue={this.state.hargaproduk} className="form-control" />
                                </div>
                              </div>
                              ...
                              <div className="card-body text-center">
                                <button type="button"  onClick={() => this.updateData(this.refs)} className="btn btn-primary">Save</button>
                                {/* <button type="button" data-toggle="modal" data-target="#myModal" onClick={() => this.updateData(this.refs)} className="btn btn-primary">Save</button> */}
