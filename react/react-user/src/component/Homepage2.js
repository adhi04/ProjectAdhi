                          ...
                          <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                            ...
                            <div className="carousel-inner" role="listbox">
                              <div className="item active">
                                <img className="d-block img-fluid" src="images/1.jpg" alt="First slide" style={{height: 370}} />
                              </div>
                              <div className="item">
                                <img className="d-block img-fluid" src="images/2.jpg" alt="Second slide" style={{height: 370}} />
                              </div>
                              <div className="item">
                                <img className="d-block img-fluid" src="images/3.jpg" alt="Third slide" style={{height: 370}} />
                              </div>
                            </div>
                            ...
                            <Link className="left carousel-control" to="#carouselExampleIndicators" data-slide="prev">
                                <span className="glyphicon glyphicon-chevron-left"></span>
                                <span className="sr-only">Previous</span>
                            </Link>
                            <Link className="right carousel-control" to="#carouselExampleIndicators" data-slide="next">
